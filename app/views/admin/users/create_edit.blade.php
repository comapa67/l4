		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tab-general">
				...
				<div class="form-group {{{ $errors->has('activated') || $errors->has('confirm') ? 'error' : '' }}}">
					<label class="col-md-2 control-label" for="confirm">Attivare Utente?</label>
					<div class="col-md-6">
						@if ($mode == 'create')
				...
				<div class="form-group {{{ $errors->has('roles') ? 'error' : '' }}}">
	                ...
	                <div class="col-md-6">
						...
						<span class="help-block">
							Seleziona un gruppo da assegnare all'utente, remember that a user takes on the permissions of the group they are assigned.
						</span>
	            	</div>
				</div>
				<!-- ./ groups -->
